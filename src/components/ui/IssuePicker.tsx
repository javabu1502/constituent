...
const POPULAR_TOPICS: { label: string; category: string; subtopics: { label: string; category: string }[] }[] = [
  ...
  },
  {
    ...
    subtopics: [
      ...
      { label: 'TPS', category: 'Immigration' },
      { label: 'E-Verify', category: 'Immigration' },
  ...
  },
  {
    ...
    subtopics: [
      ...
      { label: 'SALT Deduction', category: 'Taxation' },
  ...
  },
  {
    ...
    subtopics: [
      ...
      { label: 'WIC', category: 'Social Welfare' },
      { label: 'Section 8/Housing Vouchers', category: 'Social Welfare' },
      { label: 'SSI', category: 'Social Welfare' },
    ],
  },
  {
  ...
  },
  {
    ...
    subtopics: [
      ...
      { label: 'DEI', category: 'Civil Rights and Liberties, Minority Issues' },
  ...
  },
  {
    ...
    subtopics: [
      ...
      { label: 'Semiconductors/CHIPS', category: 'Science, Technology, Communications' },
