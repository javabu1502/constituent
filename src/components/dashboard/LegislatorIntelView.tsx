 ...
 * meeting prepared" page. Rendered by the authenticated /dashboard/legislator
 * page and the public read-only /demo/legislator page (isDemo hides the
 * meeting logger); access control is the page's job.
 */
...
export async function LegislatorIntelView({
  orgUserId,
  legislatorId,
  isDemo = false,
  backHref = '/dashboard',
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Link href={backHref} className="text-sm text-purple-600 dark:text-purple-400 hover:underline">
