...
const POLICY_AREAS: Record<string, string[]> = {
  ...
  'Families': ['Head Start', 'Child Care', 'Paid Family Leave', 'Child Welfare', 'Foster Care', 'Adoption', 'Child Tax Credit', 'Parental Rights', 'Child Safety Online', 'Child Poverty', 'Grandparent Caregivers', 'Youth Mental Health', 'Social Media Age Limits', 'Screen Time', 'Grandparent Rights', 'Surrogacy', 'Fertility Treatment', 'Single Parents', 'Child Hunger'],
...
const KEYWORD_ALIASES: Record<string, string[]> = {
  ...
  'dreamers': ['daca (dreamers)', 'immigration'],
  'dreamer': ['daca (dreamers)', 'immigration'],
  ...
  'salt': ['salt deduction (state & local tax)', 'taxation'],
  'chips act': ['semiconductors / chips act', 'science, technology'],
  'supplemental security': ['ssi (supplemental security income)', 'social welfare'],
  'diversity equity inclusion': ['dei (diversity, equity & inclusion)', 'civil rights'],
  'open internet': ['net neutrality (open internet)', 'science, technology'],
  'housing vouchers': ['section 8 / housing vouchers', 'social welfare'],
  'work authorization': ['e-verify (work authorization)', 'immigration'],
  'temporary protected status': ['tps (temporary protected status)', 'immigration'],
  ...
  'head start': ['head start', 'families', 'child care'],
  'headstart': ['head start', 'families', 'child care'],
  ...
  // Tech - expanded
  'semiconductors': ['semiconductors / chips act', 'science, technology'],
  'chips': ['semiconductors / chips act', 'science, technology'],
  ...
  'dei': ['dei (diversity, equity & inclusion)', 'civil rights and liberties, minority issues'],
  'diversity': ['dei (diversity, equity & inclusion)', 'civil rights and liberties, minority issues'],
  ...
  'wic': ['wic (women, infants & children)', 'social welfare', 'food insecurity'],
  'tanf': ['tanf', 'social welfare'],
  'ssi': ['ssi (supplemental security income)', 'disability benefits', 'social welfare'],
  ...
  'woke': ['dei (diversity, equity & inclusion)', 'civil rights and liberties, minority issues'],
  ...
  'fcc': ['internet/broadband', 'net neutrality (open internet)', 'science, technology'],
  ...
  'e verify': ['e-verify (work authorization)', 'immigration'],
  'everify': ['e-verify (work authorization)', 'immigration'],
  'pre k': ['pre-k', 'early childhood education'],
