...
export default function LocalGovernmentGuidePage() {
  return (
    <div className="py-12 px-4">
      ...
      <FaqJsonLd items={[
        { question: 'What is the difference between a mayor-council and council-manager government?', answer: 'In a mayor-council system, the mayor is the chief executive with significant administrative authority, and the council serves as the legislative body. In a council-manager system, the council sets policy and hires a professional city manager to handle day-to-day operations, while the mayor\'s role is largely ceremonial. Among US cities with populations over 10,000, about 55% use the council-manager form, while about 34% use the mayor-council form.' },
