          ...
          <section className="mb-10">
            ...
            <div className="pl-10 text-gray-600 dark:text-gray-300">
              <ul className="list-disc list-inside space-y-2">
                ...
                <li><strong className="text-gray-900 dark:text-white">Vote in primaries</strong>: In gerrymandered districts, <Link href="/guides/how-to-vote-in-a-primary-election" className="text-purple-600 dark:text-purple-400 hover:underline">the primary is the competitive election</Link>, so show up for it.</li>
