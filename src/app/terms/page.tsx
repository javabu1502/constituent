        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-300 pl-10">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong className="text-gray-900 dark:text-white">Provide accurate information.</strong> Use
                  your real name and real address. Representatives need to verify you&apos;re
                  actually their constituent.
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">Messages are sent on your behalf.</strong> When
                  you click send, your message goes to real government officials and their staff.
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">You are responsible for your messages.</strong> You
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-300 pl-10">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong className="text-gray-900 dark:text-white">Threaten, harass, or abuse</strong> officials,
                  their staff, or anyone else
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">Impersonate other people</strong> or
                  misrepresent your identity
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">Use bots or automation</strong> without
                  our explicit permission
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">Send spam</strong> or mass duplicate messages
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">Engage in illegal activity</strong> of any kind
                </li>
              </ul>
              <p className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-lg p-4 text-red-800 dark:text-red-300">
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-300 pl-10">
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong className="text-gray-900 dark:text-white">You review and can edit</strong> all
                  messages before they&apos;re sent
                </li>
                <li>
                  <strong className="text-gray-900 dark:text-white">You are responsible</strong> for the
          ...
          <section className="mb-10">
            ...
            <div className="space-y-3 text-gray-600 dark:text-gray-300 pl-10">
              <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 space-y-2">
                <p>
                  <strong className="text-yellow-800 dark:text-yellow-300">No guarantee of delivery.</strong>{' '}
                ...
                <p>
                  <strong className="text-yellow-800 dark:text-yellow-300">Not a government service.</strong>{' '}
                  <span className="text-yellow-700 dark:text-yellow-400">
                ...
                <p>
                  <strong className="text-yellow-800 dark:text-yellow-300">No guarantee of response.</strong>{' '}
                  <span className="text-yellow-700 dark:text-yellow-400">
                ...
                <p>
                  <strong className="text-yellow-800 dark:text-yellow-300">Service provided &quot;as is.&quot;</strong>{' '}
                  <span className="text-yellow-700 dark:text-yellow-400">
